  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black px-8">
      ...
      <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          <h1 className="text-5xl lgtext-6xl font-extrabold leading-tight bg-gradient-to-br from-black/90 via-black/60 to-black/90 bg-clip-text text-transparent">
...
exam-oriented notes."
          ...
          <Feature
            icon="📁"
            title="Project Notes"
            des="Well-structured documentation for
assignments and projects"
          />
          <Feature
            icon="📊"
            title="Charts & Graphs"
            des="Auto-generated diagrams, charts and
flow graphs."
          />
          <Feature
            icon="⬇️"
